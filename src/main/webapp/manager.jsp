	...
	<div>
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				<a class="navbar-brand" href="Login.jsp" style="color: white;">Login
					Page</a>
				<ul class="nav navbar-nav">
					<li><a href="employee_signup.jsp">Add Employee</a></li>
	...
	<div class="table-block">
		<table border="2px solid red" style="padding: 10px; margin: 15px">
			...
			<tr>
				...
				<td><%=user.getEmail()%></td>
			<td><%=user.getRole()%></td>
				<td><a href="remove?user_id=<%=user.getUser_id()%>"
